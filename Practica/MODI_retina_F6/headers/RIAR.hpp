...
#define ADITIONAL_HYPERNEAT_INPUTS 3	// Differential velocity and change in common velocity

#define MAX_VEL 25 //rad/s
#define MIN_VEL -4 //rad/s
#define DEFAULT_SPEED	15
#define MAX_SPEED_DIF	14				// Maximum differential speed at default speed
#define SPEED_STEP	0.25
#define RECOIL_FACTOR	2.0/3.0			// Speed in which the robot will recoil in case it colides in terms of MAX_VEL
#define TIME_RECOIL	4000000 			// microseconds
#define TIME_RECOVERY	1500000			// microseconds
#define DISCOUNT_TIME	7000000 	// microseconds
#define TURNING_TIME	500000		// microseconds for before setting the diff_v = 0
