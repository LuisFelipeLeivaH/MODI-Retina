...
#define MAX_VEL 20 //rad/s
#define MIN_VEL -4 //rad/s
#define DISCRETE_SPEEDS	150
#define RECOIL_FACTOR	1/2			// Speed in which the robot will recoil in case it colides in terms of MAX_VEL
#define TIME_RECOIL	3000000 			// microseconds
#define DISCOUNT_TIME	7000000 	// microseconds

const double d_speed = (MAX_VEL - MIN_VEL)/(DISCRETE_SPEEDS - 1);
void proccessColisions(bool colision, unsigned int *n_colision, RobotVREP * vrep, Joint * leftWheel, Joint * rightWheel, 
						unsigned long int *discount_t, long int *sim_time);
